...
abstract class UserDocumentReference
  ...
  Future<void> update({
    DateTime? smoberDate,
    FieldValue smoberDateFieldValue,
    String name,
...
class _$UserDocumentReference
  ...
  Future<void> update({
    ...
    assert(
      smoberDate == _sentinel || smoberDateFieldValue == null,
      "Cannot specify both smoberDate and smoberDateFieldValue",
    );
    assert(
    ...
    final json = {
      if (smoberDate != _sentinel)
        _$UserFieldMap['smoberDate']!: smoberDate as DateTime?,
      if (smoberDateFieldValue != null)
        _$UserFieldMap['smoberDate']!: smoberDateFieldValue,
...
class _$UserQuery extends QueryReference<User, UserQuerySnapshot>
  ...
  UserQuery orderBySmoberDate({
    ...
    final query = $referenceWithoutCursor.orderBy(_$UserFieldMap['smoberDate']!,
        descending: descending);
    var queryCursor = $queryCursor;
...
void _$assertUser(User instance) {
  const Min(18).validate(instance.age, 'age');
}
...
User _$UserFromJson(Map<String, dynamic> json) => User(
      ...
      _$JsonConverterFromJson<Timestamp, DateTime>(
          json['smoberDate'], const FirestoreDateTimeConverter().fromJson),
...
Map<String, dynamic> _$UserToJson(User instance) => <String, dynamic>{
      'id': instance.id,
      'smoberDate': _$JsonConverterToJson<Timestamp, DateTime>(
          instance.smoberDate, const FirestoreDateTimeConverter().toJson),
      'name': instance.name,
      'age': instance.age,
